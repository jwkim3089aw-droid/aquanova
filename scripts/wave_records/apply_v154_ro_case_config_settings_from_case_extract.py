...
FALLBACK_IMPORT_MARKER_START = "# V154_RO_CASE_CONFIG_IMPORT_START"
FALLBACK_IMPORT_MARKER_END = "# V154_RO_CASE_CONFIG_IMPORT_END"
EXTRACT_MARKER = "# V154_RO_CASE_CONFIG_SETTINGS_FROM_CASE_APPLIED"
MANIFEST_NAME = "v154_ro_case_config_settings_from_case_manifest.json"

LEGACY_ATTR_BRIDGES = {"_fmt_value"}
...
def main() -> int:
    ...
    if unresolved:
        raise SystemExit(
            f"V154 target is not safe to move. function={TARGET_FUNCTION} unresolved={unresolved}"
        )

    backup(legacy, "v153_before_v154")
    backup(case_config, "v153_before_v154")
    ...
    data = {
        "schema_version": "aquanova.refactor.v154.ro_case_config_settings_from_case_extract",
        ...
        "note": "Moves _settings_from_ro_case into ro.case_config and late-binds _fmt_value from legacy.",
    }
    manifest.write_text(json.dumps(data, ensure_ascii=False, indent=2), encoding="utf-8")

    print("V154 RO case_config settings-from-case extraction applied")
    print("moved_count=1")
