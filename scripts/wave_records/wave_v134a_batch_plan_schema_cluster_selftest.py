...
manifest = wr / "batch" / "v134a_plan_schema_cluster_extraction_manifest.json"
...
for name in moved:
    if name == "WaveAutomationError":
        ...
        assert "class WaveAutomationError" in pt, "WaveAutomationError missing from plan_schema"
    else:
...
print("V134A wave_batch plan_schema cluster extraction selftest PASS")
